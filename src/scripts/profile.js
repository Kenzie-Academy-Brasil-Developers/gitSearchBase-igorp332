...
function renderProfile() {
    ...
    changeUser.innerText = 'Switch User'
...
function countRepos(){
    ...
    if(user.public_repos === 0){
        ...
        message.innerText = 'This user has no Public Repositories.';
        emptyList.append(message)
    } else{
        totalRepos.innerText = `Total public repositories:${user.public_repos}`    
    }
